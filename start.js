...
async function downloadAndExtractZip() {
  try {
    ...
    console.log('AHINSA MD ZIP file downloaded successfully ✅️');
...
if (!fs.existsSync(__dirname + `/${config.SESSION_NAME}/creds.json`)) {
    if (!config.SESSION_ID) return console.log("Please Add SESSION_ID 🛑")
      const sessdata = config.SESSION_ID.replace("AHINSA-MD=", "")
...
await downloadAndExtractZip();
	console.log("Connecting AHINSA-MD...");
    const {
        version,
        isLatest
...
let up = `*AHINSA-MD connected successful ✅️*\n\n*PREFIX:* ${prefix}\n\n*AUTO_READ_STATUS:* ${autoreadStatus}\n\n*MODE:* ${mode}\n\n*ALIVE_MSG:* ${aliveMsg}\n\n*AUTO_VOICE:* ${autoVoice}\n\n*AUTO_REPLY:* ${autoReply}\n\n*AUTO_STICKER:*: ${autoSticker}\n\n*RECORDING*: ${recording}\n\n*AUTO_REACT*: ${autoReact}\n\n*ANTI_BAD*: ${badword}\n\n*ANTI_LINK*: ${antilink}\n\n*ANTI_BOT*: ${antiBot}\n\n*ALLWAYS_OFFLINE*: ${alwaysofline}\n\n*READ_CMD*: ${readCmd}\n\n*AI_CHAT*: ${aichat}\n\n*ANTI_CALL*: ${anticall}\n\n*WELCOME_GOODBYE*: ${wegb}\n\n*ANTI_DELETE*: ${antidelet}`;

conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: `https://i.ibb.co/fV8G0y1W/8352.jpg` }, caption: up })
